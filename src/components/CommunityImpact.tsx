  ...
  const impactCards = [
    {
      ...
      description: 'Volunteers mobilize across city sectors to clear litter, restore riverbanks, and beautify neighborhood thoroughfares.',
      imageUrl: 'https://images.unsplash.com/photo-1618477461853-cf6ed80faba5?auto=format&fit=crop&w=800&q=80',
      badge: 'Street & Park Sweeps',
    ...
    },
    {
      ...
      description: 'Sorting collected plastics, aluminum, and organic matter into specialized reprocessing programs while distributing warm clothing packs.',
